    ...
    <View style={[styles.goalCard, item.isCompleted && styles.goalCardCompleted]}>
      ...
      {item.targetAmount ? (
         <View style={[styles.goalProgressSection, item.isCompleted && styles.goalProgressSectionCompleted]}>
            ...
            <View style={[styles.progressBarTrack, item.isCompleted && { backgroundColor: 'rgba(6, 214, 160, 0.2)' }]}>
...
const styles = StyleSheet.create({
  ...
  createGoalSection: { backgroundColor: Colors.white, padding: 25, borderRadius: 28, marginBottom: 30, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.05, shadowRadius: 20, elevation: 4 },
  ...
  premiumInput: { backgroundColor: Colors.surface, borderRadius: 16, paddingHorizontal: 20, height: 56, marginBottom: 15, fontSize: 16, color: Colors.text },
  targetRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  targetInputWrapper: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: 16, paddingHorizontal: 20, height: 56, marginRight: 15 },
  ...
  goalCard: { backgroundColor: Colors.white, borderRadius: 28, padding: 25, marginBottom: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.06, shadowRadius: 15, elevation: 5 },
  goalCardCompleted: { backgroundColor: 'rgba(6, 214, 160, 0.04)', borderColor: 'rgba(6, 214, 160, 0.4)', borderWidth: 1 },
  ...
  goalDeleteBtn: { padding: 8, backgroundColor: Colors.surface, borderRadius: 20, marginLeft: 10 },
  completedTitleText: { color: Colors.success },
  completedDescText: { color: Colors.success, opacity: 0.8 },

  goalProgressSection: { marginTop: 25, backgroundColor: 'rgba(76, 201, 240, 0.05)', padding: 20, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(76, 201, 240, 0.15)' },
  goalProgressSectionCompleted: { backgroundColor: 'rgba(6, 214, 160, 0.1)', borderColor: 'rgba(6, 214, 160, 0.3)' },
  ...
  progressBarTrack: { height: 16, backgroundColor: 'rgba(76, 201, 240, 0.15)', borderRadius: 8, overflow: 'hidden' },
  ...
  logModal: { backgroundColor: Colors.white, padding: 25, borderRadius: 24, width: '85%', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 20, elevation: 10 },
  ...
  logInputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: 16, paddingHorizontal: 20, height: 60, marginBottom: 25 },
